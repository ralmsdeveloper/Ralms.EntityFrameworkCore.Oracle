...
namespace Ralms.EntityFrameworkCore.Oracle.Internal
{
    /// <summary>
    ...
    public static class OracleStrings
    {
        private static readonly ResourceManager _resourceManager
            = new ResourceManager("Ralms.EntityFrameworkCore.Oracle.Properties.OracleStrings", typeof(OracleStrings).GetTypeInfo().Assembly);
